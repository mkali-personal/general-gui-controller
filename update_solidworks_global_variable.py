...
# %%
# detect_template_and_act(r"solidworks - search bar", relative_position=(1.386, 0.674), sleep_after_action=SHORT_SLEEP,
#                         text_to_paste='eq')
#
...
checkbox_position = detect_template_and_act(
    r"solidworks - solidworks link to external file marked checkbox - 2560-1440.png", relative_position=(0.092, 0.474))
